...
|[#3](https://github.com/totalnoMartina/irish-macrame/issues/3) Add page that displays items details with ability to add item to shopping cart| ![Macrame Details page](/media/macrame_detail.png?raw=true)|Should Have|
...
|[#5](https://github.com/totalnoMartina/irish-macrame/issues/5) A button for shopping and browsing macrames|![Browse/Shop here button](/media/browse_btn.png?raw=true)|Must Have|
...
|[#9](https://github.com/totalnoMartina/irish-macrame/issues/9) Create User Profile Page |![My Profile User page](/media/my_profile_pg.png?raw=true)
...
|[#13](https://github.com/totalnoMartina/irish-macrame/issues/13) Add messages to indicate status of the adding items into cart| ![Shopping Cart](/media/messages_status.png?raw=true)|Must Have|
|[#14](https://github.com/totalnoMartina/irish-macrame/issues/14) Add Footer with links| ![Footer](/media/footer.png?raw=true)|Must Have|
...
![Mobile navigation](/media/nav_mob.jpg?raw=true)
