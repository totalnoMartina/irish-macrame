...
def checkout(request):
    """ A function to handle checking out and payments """
    ...
    if request.method == 'POST':
        ...
        if order_form.is_valid():
            ...
            for item_id, item_data in shoppingcart.items():
                try:
                    macrame = Macrame.objects.get(id=item_id)
                    if isinstance(item_data, int):
                        ...
                        for size, quantity in item_data['items_by_size'].items():
                            ...
                            order_line_item.save()
                except Macrame.DoesNotExist:
                    messages.error(request, (
                        'One of the items in your cart wasn\'t \
                        found in our database.\
                        Please call us for assistance!')
                    )
                    order.delete()
                    return redirect(reverse('view_shoppingcart'))
            # Try to save info of a user if all in order
